                                ...
                                argument("confirm", string())
                                    .executes { context: CommandContext<ServerCommandSource> ->
                                        ...
                                        ServerCommandCallbacks.RegisterCallback.EVENT.invoker.execute(
                                            ...
                                            context.source.player?.sendMessage(Text.of(it), false)
                                        }
                                    ...
                                    argument("amount", integer())
                                        .executes { context: CommandContext<ServerCommandSource> ->
                                            ...
                                            ServerCommandCallbacks.BanCallback.EVENT.invoker.execute(
                                                ...
                                                context.source.player?.sendMessage(Text.of(send), false)
                                                disconnect?.also {
                                                    player.networkHandler.disconnect(Text.of(disconnect))
                                                }
                                            }
                                            Command.SINGLE_SUCCESS
                                        }
