 ...
 * @author Enaium
 */
object ServerCommandLogoutCallbackImpl : ServerCommandCallbacks.LogoutCallback {
    override fun execute(player: Player, send: (String) -> Unit) {
        Authenticate.logout(player)
        send(i18n("authenticate.command.logout.success"))
    }
}